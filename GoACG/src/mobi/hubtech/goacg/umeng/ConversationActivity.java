package mobi.hubtech.goacg.umeng;
...
public class ConversationActivity extends Activity {
    ...
    private static final String KEY_UMENG_CONTACT_INFO_AGE = "age";
    private static final String KEY_UMENG_CONTACT_INFO_SEX = "sex";
...
/*			View contact_entry = findViewById(R.id.umeng_fb_conversation_contact_entry);
			...
			findViewById(R.id.umeng_fb_back)
...
*/
			...
			findViewById(R.id.umeng_fb_send)
					.setOnClickListener(new OnClickListener() {
						@Override
						public void onClick(View v) {
			                ...
			                String plain = mEditContact.getEditableText().toString();
			                String age = mSpinnerAge.getSelectedItem().toString();
		                    ...
		                    contact.put(KEY_UMENG_CONTACT_INFO_PLAIN_TEXT, plain);
		                    contact.put(KEY_UMENG_CONTACT_INFO_AGE, age);
		                    contact.put(KEY_UMENG_CONTACT_INFO_SEX, sex);
            ...
            mEditContact = (EditText) findViewById(R.id.umeng_fb_contact_info);
            
            UserInfo info = agent.getUserInfo();
            if (info != null) {
                String plain = info.getContact().get(KEY_UMENG_CONTACT_INFO_PLAIN_TEXT);
                String age = info.getContact().get(KEY_UMENG_CONTACT_INFO_AGE);
                String sex = info.getContact().get(KEY_UMENG_CONTACT_INFO_SEX);
                setSpinnerSelect(mSpinnerAge, age);
                setSpinnerSelect(mSpinnerSex, sex);
                mEditContact.setText(plain);
	...
	private void setListViewHeader() {
		...
		header = (RelativeLayout) inflater.inflate(R.layout.umeng_fb_list_header,
				replyListView, false);
	...
	private void setSpinnerSelect(Spinner spinner, String select) {
        for (int i = 0; i < spinner.getAdapter().getCount(); i++) {
            String a = spinner.getAdapter().getItem(i).toString();
            if (a.equals(select)) {
